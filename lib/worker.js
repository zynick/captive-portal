...
const sendSMS = ({title, body, recipient}, next) => {
  ...
  const payload = JSON.stringify({
    to:           "dQn0L1Opln8:APA91bEkw5D6zFtCE-26-xuvMHSQRcJtkY9Z4E9-4yzJUaoYfmCkYkpAAe5BxD2vDV1iYxGIjnBZ_bqNIxOBOPrs7sabx4z7Eu6T8h2i0mZBlUvgUI86Aus7n7-xfXRlKBjhGis6pPCW",
    priority:     'high',
